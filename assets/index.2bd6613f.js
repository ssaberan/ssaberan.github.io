var e=Object.defineProperty,t=Object.getOwnPropertySymbols,n=Object.prototype.hasOwnProperty,a=Object.prototype.propertyIsEnumerable,l=(t,n,a)=>n in t?e(t,n,{enumerable:!0,configurable:!0,writable:!0,value:a}):t[n]=a,r=(e,r)=>{for(var i in r||(r={}))n.call(r,i)&&l(e,i,r[i]);if(t)for(var i of t(r))a.call(r,i)&&l(e,i,r[i]);return e},i=(e,l)=>{var r={};for(var i in e)n.call(e,i)&&l.indexOf(i)<0&&(r[i]=e[i]);if(null!=e&&t)for(var i of t(e))l.indexOf(i)<0&&a.call(e,i)&&(r[i]=e[i]);return r};import{$ as o,q as c,L as m,I as s,B as d,a as u,r as g,R as p,F as f,b as h,w as x,P as b,H as E,u as w,c as y,d as v,e as k,f as _,S as T,g as I,h as F,i as j}from"./vendor.be097c2e.js";const R=o`
* {
...
`,de=c.label`
   ...
   color: red;
   margin-top: 5px;
`,ue=e=>{var t=e,{label:n}=t,a=i(t,["label"]);const[l,r]=w(a);return p.createElement(p.Fragment,null,p.createElement(se,null,n),p.createElement(me,{name:l.name,value:l.value,onChange:l.onChange,onBlur:l.onBlur}),r.touched&&r.error?p.createElement(de,null,r.error):null)};ue.propTypes={label:b.string};const ge=c.textarea`
   margin: auto;
   display: block;
   width: 100%;
   height: 12rem;
...
`,fe=c.label`
   ...
   color: red;
   margin-top: 5px;
`,he=e=>{var t=e,{label:n,rows:a}=t,l=i(t,["label","rows"]);const[r,o]=w(l);return p.createElement(p.Fragment,null,p.createElement(pe,null,n),p.createElement(ge,{name:r.name,value:r.value,onChange:r.onChange,onBlur:r.onBlur,rows:a}),o.touched&&o.error?p.createElement(fe,null,o.error):null)};he.propTypes={label:b.string,rows:b.number};const xe=e=>{const t={};return e.name.trim()||(t.name="A name is required to submit"),e.subject.trim()||(t.subject="A subject is required to submit"),e.message.trim()||(t.message="A message is required to submit"),t},be=e=>!!(e.name.trim()&&e.subject.trim()&&e.message.trim());const Ee=c.div`
   display: block;
   margin: auto;
   text-align: center;
   color: white;
...
`,Fe=c.div`
   margin: 50px 0px;
`,je=()=>{const[e,t]=g.exports.useState("form"),n=e=>{e.preventDefault(),k.sendForm("service_wuk7fha","template_iwcxr0f",e.target,"user_L5iDeh6WPPpM7T9mHslFG").then((e=>{console.log(e.text),t("sent")}),(e=>{console.log(e.text),t("error")}))};return"sent"===e?p.createElement(p.Fragment,null,p.createElement(E,null,p.createElement("title",null,"Email Sent")),p.createElement(we,null,p.createElement(Ee,null,p.createElement("h1",null,"Sent!"),p.createElement(ye,{src:"/assets/sent.5c48c0c5.svg"})))):"error"===e?p.createElement(p.Fragment,null,p.createElement(E,null,p.createElement("title",null,"Email Sent")),p.createElement(ke,null,p.createElement(ve,null,p.createElement("h1",null,"Oh No! It looks like the email failed to send!"),p.createElement("h3",null,"I'm working on fixing the issue. Until then, you can email me at ssaberan96@gmail.com."),p.createElement(_e,{src:"/assets/error.7aca0d6e.svg"})))):p.createElement(p.Fragment,null,p.createElement(E,null,p.createElement("title",null,"Contact Form")),p.createElement(v,{initialValues:{name:"",subject:"",message:""},validate:xe},(({values:e})=>p.createElement(Ie,null,p.createElement(Te,{onSubmit:n,autoComplete:"off"},p.createElement("h1",null,"Contact Form"),p.createElement("h3",null,"Send an email to Soroush"),p.createElement(Fe,null,p.createElement(ue,{name:"name",label:"Name"})),p.createElement(Fe,null,p.createElement(ue,{name:"subject",label:"Subject"})),p.createElement(Fe,null,p.createElement(he,{name:"message",label:"Message"})),p.createElement(D,{type:"submit",text:"Send",disabled:!be(e)}))))))},Re=p.createElement("a",{href:"https://en.wikipedia.org/wiki/Basel_problem",target:"_blank",rel:"noreferrer"},"*"),Se=p.createElement("img",{src:"https://latex.codecogs.com/gif.latex?f",title:"f"}),Ce=p.createElement("img",{src:"https://latex.codecogs.com/gif.latex?a",title:"a"}),$e=p.createElement("img",{src:"https://latex.codecogs.com/gif.latex?f(a)=\\sum_{n=0}^{\\infty}\\frac{f^{(n)}(a)}{n!}(x-a)^{n}",title:"f(a)=\\sum_{n=0}^{\\infty}\\frac{f^{(n)}(a)}{n!}(x-a)^{n}"}),Pe=p.createElement("img",{src:"https://latex.codecogs.com/gif.latex?S",title:"S"}),Be=p.createElement("img",{src:"https://latex.codecogs.com/gif.latex?\\sum_{n=1}^{\\infty}\\frac{1}{n^{2}}",title:"\\sum_{n=1}^{\\infty}\\frac{1}{n^{2}}"}),ze=p.createElement("img",{src:"https://latex.codecogs.com/gif.latex?\\frac{1}{n^{2}}=f^{(n-1)}(a)\\frac{(x-a)^{n-1}}{(n-1)!}\\;&space;for\\;&space;n&space;\\in&space;\\mathbb{N}",title:"\\frac{1}{n^{2}}=f^{(n-1)}(a)\\frac{(x-a)^{n-1}}{(n-1)!}\\; for\\; n \\in \\mathbb{N}"}),Me=p.createElement("img",{src:"https://latex.codecogs.com/gif.latex?x",title:"x"}),Ae=p.createElement("img",{src:"https://latex.codecogs.com/gif.latex?x=2",title:"x=2"}),Ne=p.createElement("img",{src:"https://latex.codecogs.com/gif.latex?a=1",title:"a=1"}),Oe=p.createElement("img",{src:"https://latex.codecogs.com/gif.latex?\\frac{1}{n^{2}}=f^{(n-1)}(1)\\frac{1}{(n-1)!}\\;&space;for\\;&space;n\\in&space;\\mathbb{N}",title:"\\frac{1}{n^{2}}=f^{(n-1)}(1)\\frac{1}{(n-1)!}\\; for\\; n\\in \\mathbb{N}"}),He=p.createElement("img",{src:"https://latex.codecogs.com/gif.latex?\\inline&space;f^{(n)}(1)",title:"f^{(n)}(1)"}),qe=p.createElement("img",{src:"https://latex.codecogs.com/gif.latex?f^{(n)}(1)=\\frac{n!}{(n&plus;1)^{2}}\\;&space;for\\;&space;n\\in&space;\\mathbb{N}\\cup\\{0\\}",title:"f^{(n)}(1)=\\frac{n!}{(n+1)^{2}}\\; for\\; n\\in \\mathbb{N}\\cup\\{0\\}"}),Le=p.createElement("img",{src:"https://latex.codecogs.com/gif.latex?x=1",title:"x=1"}),We=p.createElement("img",{src:"https://latex.codecogs.com/gif.latex?f(x)=\\sum_{n=0}^{\\infty}\\frac{f^{(n)}(1)}{n!}(x-1)^{n}",title:"f(x)=\\sum_{n=0}^{\\infty}\\frac{f^{(n)}(1)}{n!}(x-1)^{n}"}),De=p.createElement("img",{src:"https://latex.codecogs.com/gif.latex?\\inline&space;f^{(n)}(1)=\\frac{n!}{(n&plus;1)^{2}}",title:"f^{(n)}(1)=\\frac{n!}{(n+1)^{2}}"}),Ye=p.createElement("img",{src:"https://latex.codecogs.com/gif.latex?f(x)=\\sum_{n=0}^{\\infty}\\frac{\\frac{n!}{(n&plus;1)^{2}}}{n!}(x-1)^{n}=\\sum_{n=0}^{\\infty}\\frac{(x-1)^{n}}{(n&plus;1)^{2}}",title:"f(x)=\\sum_{n=0}^{\\infty}\\frac{\\frac{n!}{(n+1)^{2}}}{n!}(x-1)^{n}=\\sum_{n=0}^{\\infty}\\frac{(x-1)^{n}}{(n+1)^{2}}"}),Ge=p.createElement("img",{src:"https://latex.codecogs.com/gif.latex?\\inline&space;\\sum_{n=0}^{\\infty}t^{n}=\\frac{1}{1-t}",title:"\\sum_{n=0}^{\\infty}t^{n}=\\frac{1}{1-t}"}),Ue=p.createElement("img",{src:"https://latex.codecogs.com/gif.latex?\\inline&space;\\sum_{n=0}^{\\infty}\\frac{(x-1)^{n}}{(n&plus;1)^{2}}",title:"\\sum_{n=0}^{\\infty}\\frac{(x-1)^{n}}{(n+1)^{2}}"}),Ve=p.createElement("img",{src:"https://latex.codecogs.com/gif.latex?\\sum_{n=0}^{\\infty}t^{n}=\\frac{1}{1-t}\\Rightarrow",title:"\\sum_{n=0}^{\\infty}t^{n}=\\frac{1}{1-t}\\Rightarrow"}),Je=p.createElement("img",{src:"https://latex.codecogs.com/gif.latex?\\int_{0}^{x}\\sum_{n=0}^{\\infty}t^{n}dt=\\int_{0}^{x}\\frac{1}{1-t}dt\\Rightarrow",title:"\\int_{0}^{x}\\sum_{n=0}^{\\infty}t^{n}dt=\\int_{0}^{x}\\frac{1}{1-t}dt\\Rightarrow"}),Ke=p.createElement("img",{src:"https://latex.codecogs.com/gif.latex?\\sum_{n=0}^{\\infty}\\frac{x^{n&plus;1}}{n&plus;1}=ln(1-x)\\Rightarrow",title:"\\sum_{n=0}^{\\infty}\\frac{x^{n+1}}{n+1}=ln(1-x)\\Rightarrow"}),Qe=p.createElement("img",{src:"https://latex.codecogs.com/gif.latex?\\sum_{n=0}^{\\infty}\\frac{x^{n}}{n&plus;1}=\\frac{ln(1-x)}{x}\\Rightarrow",title:"\\sum_{n=0}^{\\infty}\\frac{x^{n}}{n+1}=\\frac{ln(1-x)}{x}\\Rightarrow"}),Xe=p.createElement("img",{src:"https://latex.codecogs.com/gif.latex?\\int_{0}^{x}\\sum_{n=0}^{\\infty}\\frac{t^{n}}{n&plus;1}dt=\\int_{0}^{x}\\frac{ln(1-t)}{t}dt\\Rightarrow",title:"\\int_{0}^{x}\\sum_{n=0}^{\\infty}\\frac{t^{n}}{n+1}dt=\\int_{0}^{x}\\frac{ln(1-t)}{t}dt\\Rightarrow"}),Ze=p.createElement("img",{src:"https://latex.codecogs.com/gif.latex?\\sum_{n=0}^{\\infty}\\frac{x^{n&plus;1}}{(n&plus;1)^{2}}=\\int_{0}^{x}\\frac{ln(1-t)}{t}dt\\Rightarrow",title:"\\sum_{n=0}^{\\infty}\\frac{x^{n+1}}{(n+1)^{2}}=\\int_{0}^{x}\\frac{ln(1-t)}{t}dt\\Rightarrow"}),et=p.createElement("img",{src:"https://latex.codecogs.com/gif.latex?\\sum_{n=0}^{\\infty}\\frac{(x-1)^{n&plus;1}}{(n&plus;1)^{2}}=\\int_{0}^{x-1}\\frac{ln(1-t)}{t}dt\\Rightarrow",title:"\\sum_{n=0}^{\\infty}\\frac{(x-1)^{n+1}}{(n+1)^{2}}=\\int_{0}^{x-1}\\frac{ln(1-t)}{t}dt\\Rightarrow"}),tt=p.createElement("img",{src:"https://latex.codecogs.com/gif.latex?\\sum_{n=0}^{\\infty}\\frac{(x-1)^{n}}{(n&plus;1)^{2}}=\\frac{1}{x-1}\\int_{0}^{x-1}\\frac{ln(1-t)}{t}dt\\Rightarrow",title:"\\sum_{n=0}^{\\infty}\\frac{(x-1)^{n}}{(n+1)^{2}}=\\frac{1}{x-1}\\int_{0}^{x-1}\\frac{ln(1-t)}{t}dt\\Rightarrow"}),nt=p.createElement("img",{src:"https://latex.codecogs.com/gif.latex?f(x)=\\frac{1}{x-1}\\int_{0}^{x-1}\\frac{ln(1-t)}{t}dt",title:"f(x)=\\frac{1}{x-1}\\int_{0}^{x-1}\\frac{ln(1-t)}{t}dt"}),at=p.createElement("img",{src:"https://latex.codecogs.com/gif.latex?\\inline&space;f(x)=\\frac{1}{x-1}\\int_{0}^{x-1}\\frac{ln(1-t)}{t}dt",title:"f(x)=\\frac{1}{x-1}\\int_{0}^{x-1}\\frac{ln(1-t)}{t}dt"}),lt=p.createElement("img",{src:"https://latex.codecogs.com/gif.latex?\\frac{\\pi^{2}}{6}",title:"\\frac{\\pi^{2}}{6}"}),rt=p.createElement("img",{src:"https://latex.codecogs.com/gif.latex?-\\frac{\\pi^{2}}{6}",title:"-\\frac{\\pi^{2}}{6}"}),it=p.createElement("img",{src:"https://latex.codecogs.com/gif.latex?1=-1",title:"1=-1"}),ot=c.div`
   margin: auto;
   width: 60%;
   padding-top: 30px;
   padding-bottom: 50px;
...
`,ct=()=>p.createElement(p.Fragment,null,p.createElement(E,null,p.createElement("title",null,"Blog Post 1")),p.createElement(ot,null,p.createElement(p.Fragment,null,p.createElement("h1",null,"A bizarre way of evaluating infinite series'"),p.createElement("br",null),p.createElement("p",null,"Given a function ",Se," that is infinitely differentiable around a point ",Ce,", we can derive the Taylor expansion of ",Se," around ",Ce," as follows:"),p.createElement("br",null),p.createElement("p",null,$e),p.createElement("br",null),p.createElement("p",null,"However, is the reverse also possible to derive? In other words, given an infinite series ",Pe,", can we find a function ",Se," such that the Taylor expansion of ",Se," around some infinitely differentiable point ",Ce," is ",Pe,"? If this is possible, we might be able to use the resulting function to evaluate ",Pe,"."),p.createElement("br",null),p.createElement("p",null,"When investigating this, I decided to use this idea to attempt to solve the famous Basel problem in a new, bizarre way. First proposed in 1650, and solved by Leonhard Eulor in 1734",Re,", the Basel problem asks to evaluate the following:"),p.createElement("br",null),p.createElement("p",null,Be),p.createElement("br",null),p.createElement("p",null,"Lets call this infinite sum ",Pe,". So if we treat ",Pe," as a Taylor expansion of some unknown function ",Se,", then we can write each term in ",Pe," as follows:"),p.createElement("br",null),p.createElement("p",null,ze),p.createElement("br",null),p.createElement("p",null,"Our choice for ",Me," and ",Ce," is arbitrary, so lets choose values that simplify the problem. If we let ",Ae," and ",Ne,", we get the following:"),p.createElement("br",null),p.createElement("p",null,Oe),p.createElement("br",null),p.createElement("p",null,"Rearranging the terms to isolate ",He," gives us:"),p.createElement("br",null),p.createElement("p",null,qe),p.createElement("br",null),p.createElement("p",null,"So given the requirement above, what is ",Se,"?"),p.createElement("br",null),p.createElement("p",null,"If you take the Taylor expansion of ",Se," centered around ",Le,", you get the following:"),p.createElement("br",null),p.createElement("p",null,We),p.createElement("br",null),p.createElement("p",null,"Substituting for ",De," yields:"),p.createElement("br",null),p.createElement("p",null,Ye),p.createElement("br",null),p.createElement("p",null,"Now use the formula, ",Ge,". We want to manipulate the left side of this equation until it becomes ",Ue,". Then whatever is on the right side will be ",Se,":"),p.createElement("br",null),p.createElement("p",null,Ve),p.createElement("br",null),p.createElement("p",null,Je),p.createElement("br",null),p.createElement("p",null,Ke),p.createElement("br",null),p.createElement("p",null,Qe),p.createElement("br",null),p.createElement("p",null,Xe),p.createElement("br",null),p.createElement("p",null,Ze),p.createElement("br",null),p.createElement("p",null,et),p.createElement("br",null),p.createElement("p",null,tt),p.createElement("br",null),p.createElement("p",null,"So we get that"),p.createElement("br",null),p.createElement("p",null,nt),p.createElement("br",null),p.createElement("p",null,"is the value for ",Se," when ",Ae," we were looking for, thus showing that it is possible to derive a function from its Taylor expansion for ",p.createElement("i",null,"some")," series ",Pe," around some infinitely differentiable point (in this case ",Ne,")."),p.createElement("br",null),p.createElement("p",null,"Except for one not-so-minor detail..."),p.createElement("br",null),p.createElement("p",null,"Assuming I did everything right, if we plug ",Ae," into"," ",at,", we should expect to get the answer to the Basel problem, which was confirmed to be ",lt," by Leonhard Eulor in 1734",Re,". However, doing so yields ",rt," for whatever reason, meaning I made a mistake in my math somewhere (or that ",it," haha). Maybe someday I will revisit this and find where I went wrong."))));function mt(){return p.createElement(_,null,p.createElement(R,null),p.createElement(L,null),p.createElement(q,null),p.createElement(T,null,p.createElement(I,{path:"/",to:"/home",exact:!0,component:le}),p.createElement(F,{path:"/home",exact:!0,component:le}),p.createElement(F,{path:"/blog",exact:!0,component:ie}),p.createElement(F,{path:"/projects",exact:!0,component:oe}),p.createElement(F,{path:"/resume",exact:!0,component:ce}),p.createElement(F,{path:"/contact",exact:!0,component:je}),p.createElement(F,{path:"/blog/1",exact:!0,component:ct})))}j.render(p.createElement(mt,null),document.getElementById("root"));
